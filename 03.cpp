...
//}
//int CalculateB(Rect Rect) {
//	return Rect.Height * Rect.width;
//}
//
//int CalculateScore(Student Student) 
//{
//	return Student.MathScore + Student.EngScore;
//}
//
//
//
...
//	Rect.width = 5;
//
//	float ResultA = CalculateA(&Rect);
//	CalculateA(&Rect);
//
//	cout << CalculateA(&Rect) << endl;
//
//
//	//float Health;
//	//float Damage;
